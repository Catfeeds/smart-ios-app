...
//	_backgroundWindow.hidden = false;
    
	[[UIApplication sharedApplication].keyWindow addSubview:_backgroundWindow];
	...
	//    [UIView animateWithDuration:_easeInDuration delay:0.25f options:UIViewAnimationOptionCurveEaseInOut animations:^{
...
- (void)stop
{
    ...
    [UIView animateWithDuration:_easeInDuration delay:0.0f options:UIViewAnimationOptionCurveEaseInOut animations:^{
        _blurView.effect = nil;
        _indicatorView.alpha = 0.0f;
    } completion:^(BOOL finished) {
