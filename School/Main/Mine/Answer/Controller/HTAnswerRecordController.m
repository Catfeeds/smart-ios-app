...
@interface HTAnswerRecordController ()
...
@implementation HTAnswerRecordController
...
- (void)initializeDataSource {
    ...
    [self.tableView ht_setRefreshBlock:^(NSString *pageSize, NSString *currentPage) {
        ...
        [HTRequestManager requestUserAnswerListWithNetworkModel:networkModel uidString:weakSelf.uidString pageSize:pageSize currentPage:currentPage complete:^(id response, HTError *errorModel) {
...
- (void)initializeUserInterface {
    self.navigationItem.title = @"提出的问题";
